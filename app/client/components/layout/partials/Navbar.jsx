				...
				<div className="container-fluid">
					<div className="pmd-navbar-right-icon pull-right navigation">
						...
						<div className="dropdown notification icons pmd-dropdown">
							...
							<a href="javascript:void(0)" title="Notification" className="dropdown-toggle pmd-ripple-effect"  data-toggle="dropdown" role="button" aria-expanded="true">
								<div data-badge="3" className="material-icons md-light pmd-sm pmd-badge  pmd-badge-overlap">notifications_none</div>
							</a>
							
							<div className="dropdown-menu dropdown-menu-right pmd-card pmd-card-default pmd-z-depth" role="menu">
								<div className="pmd-card-title">
									<div className="media-body media-middle">
										<a href="notifications.html" className="pull-right">3 new notifications</a>
										<h3 className="pmd-card-title-text">Notifications</h3>
									</div>
								</div>
								
								<ul className="list-group pmd-list-avatar pmd-card-list">
									<li className="list-group-item hidden">
										<p className="notification-blank">
											<span className="dic dic-notifications-none"></span>
									...
									<li className="list-group-item unread">
										<a href="javascript:void(0)">
											<div className="media-left">
												<span className="avatar-list-img40x40">
													<img alt="40x40" data-src="holder.js/40x40" className="img-responsive" src="themes/images/profile-1.png" data-holder-rendered="true"/>
												</span>
											</div>
											<div className="media-body">
												<span className="list-group-item-heading"><span>Prathit</span> posted a new challanegs</span>
												<span className="list-group-item-text">5 Minutes ago</span>
											</div>
										</a>
									</li>
									<li className="list-group-item">
										<a href="javascript:void(0)">
											<div className="media-left">
												<span className="avatar-list-img40x40">
													<img alt="40x40" data-src="holder.js/40x40" className="img-responsive" src="themes/images/profile-2.png" data-holder-rendered="true"/>
												</span>
											</div>
											<div className="media-body">
												<span className="list-group-item-heading"><span>Keel</span> Cloned 2 challenges.</span>
												<span className="list-group-item-text">15 Minutes ago</span>
											</div>
										</a>
									</li>
									<li className="list-group-item unread">
										<a href="javascript:void(0)">
											<div className="media-left">
												<span className="avatar-list-img40x40">
													<img alt="40x40" data-src="holder.js/40x40" className="img-responsive" src="themes/images/profile-3.png" data-holder-rendered="true"/>
												</span>
											</div>
											
											<div className="media-body">
												<span className="list-group-item-heading"><span>John</span> posted new collection.</span>
												<span className="list-group-item-text">25 Minutes ago</span>
											</div>
										</a>
									</li>
									<li className="list-group-item unread">
										<a href="javascript:void(0)">
											<div className="media-left">
												<span className="avatar-list-img40x40">
													<img alt="40x40" data-src="holder.js/40x40" className="img-responsive" src="themes/images/profile-4.png" data-holder-rendered="true"/>
												</span>
											</div>
											<div className="media-body">
												<span className="list-group-item-heading"><span>Valerii</span> Shared 5 collection.</span>
												<span className="list-group-item-text">30 Minutes ago</span>
											</div>
										</a>
									</li>
								</ul>
					...
					<div className="navbar-header">
						<a href="javascript:void(0);" className="btn btn-sm pmd-btn-fab pmd-btn-flat pmd-ripple-effect pull-left margin-r8 pmd-sidebar-toggle"><i className="material-icons">menu</i></a>
						<a href="/" className="navbar-brand">
							<svg version="1.1" x="0px" y="0px" width="174.16px" height="48px" viewBox="0 0 174.16 48" enableBackground="new 0 0 174.16 48">
								<g>
									<g>
										<path fill="#FFFFFF" d="M8.658,17.795c5.339,0,8.403,2.64,8.403,7.251c0,4.792-3.064,7.585-8.403,7.585H3.773v6.4h-3.58V17.795
										H8.658z M3.773,29.415h4.733c3.276,0,5.127-1.395,5.127-4.278c0-2.792-1.851-4.125-5.127-4.125H3.773V29.415z"></path>
										...
										c3.276,0,5.158-1.395,5.158-4.278c0-2.792-1.881-4.125-5.158-4.125H23.16v8.403H28.196z"></path>
									...
									l4.412,0.115l6.468,1.056l0.701-0.109L62.295,26.706z"></path>
									...
									l0.069,0.024L62.993,23.863z"></path>
									<path opacity="0.2" fillRule="evenodd" clipRule="evenodd" fill="#000001" d="M62.383,23.631l0.001,1.388
									...
									<path fillRule="evenodd" clipRule="evenodd" fill="none" stroke="#2A100A" fontSize="1.167" strokeLinecap="round" strokeMiterlimit="2.6131" d="
									M48.769,34.872c0,0,2.086,1.539,5.132,0.008"></path>
									<g>
										...
										l0.003-0.012l0.004-0.01l0.004-0.012L51.983,37.144z"></path>
									</g>
									<path opacity="0.2" fillRule="evenodd" clipRule="evenodd" fill="#000001" d="M60.076,25.364
									...
									c0.641,0,1.204-0.12,1.523-0.3c0.678-0.556,1.93-0.899,4.271-1.038C58.313,25.019,59.341,25.147,60.076,25.364z"></path>
									<path fillRule="evenodd" clipRule="evenodd" fill="#2A100A" d="M60.874,24.703c1.304,0.027,1.868,0.673,3.203,0.673
									...
									c0.715-0.556,2.037-0.9,4.506-1.039C59.014,24.359,60.098,24.487,60.874,24.703z"></path>
									<path fillRule="evenodd" clipRule="evenodd" fill="#2A100A" d="M49.886,10.032c0.27-0.036,0.546-0.063,0.83-0.079L50.714,9.94
									...
									l-0.031,0.004h0l-0.034,0.007l0,0C50.458,8.313,49.986,9.067,49.886,10.032z"></path>
									<g>
										<path fillRule="evenodd" clipRule="evenodd" fill="#2A100A" d="M42.527,7.231c-3.94,0-7.134,0.589-7.134,1.314
										c0,0.726,3.194,1.315,7.134,1.315s7.134-0.589,7.134-1.315C49.661,7.82,46.467,7.231,42.527,7.231z"></path>
										<path fillRule="evenodd" clipRule="evenodd" fill="#2A100A" d="M59.916,7.231c3.939,0,7.134,0.589,7.134,1.315
										c0,0.726-3.194,1.314-7.134,1.314c-3.94,0-7.134-0.588-7.134-1.314C52.782,7.82,55.976,7.231,59.916,7.231z"></path>
									</g>
									<path fillRule="evenodd" clipRule="evenodd" fill="#FFCE88" d="M45.161,25.369c4.019,0.226,4.213,1.133,4.277,2.776
									c-0.064,5.01-7.675,7.154-8.901,2.201c-0.274-1.285-0.309-2.578,0.268-3.511C41.3,26.036,41.976,25.369,45.161,25.369z"></path>
									<path fillRule="evenodd" clipRule="evenodd" fill="#FFCE88" d="M57.517,25.369c-4.02,0.226-4.213,1.133-4.277,2.776
									c0.064,5.01,7.674,7.154,8.901,2.201c0.273-1.285,0.308-2.578-0.268-3.511C61.377,26.036,60.702,25.369,57.517,25.369z"></path>
									<polygon fillRule="evenodd" clipRule="evenodd" fill="#2A100A" points="61.347,29.12 58.06,27.25 57.79,28.128 59.439,29.114
									57.812,30.081 58.083,30.978 	"></polygon>
									<polygon fillRule="evenodd" clipRule="evenodd" fill="#2A100A" points="56.937,26.886 57.635,26.886 56.293,31.024
									55.595,31.024 	"></polygon>
									<polygon fillRule="evenodd" clipRule="evenodd" fill="#2A100A" points="42.54,29.138 45.899,27.226 46.176,28.122 44.49,29.132
									46.153,30.12 45.877,31.038 	"></polygon>
									<g>
										<path opacity="0.7" fillRule="evenodd" clipRule="evenodd" fill="#FFFFFF" d="M44.813,25.968c-2.095,0-2.64,0.313-3.086,0.69
										...
										<path opacity="0.7" fillRule="evenodd" clipRule="evenodd" fill="#FFFFFF" d="M57.637,25.968c-2.095,0-2.641,0.313-3.087,0.69
									...
									<path opacity="0.2" fillRule="evenodd" clipRule="evenodd" fill="#000001" d="M62.417,24.581l7.641,3.064
									...
									<path fillRule="evenodd" clipRule="evenodd" fill="#192866" d="M63.419,24.381l7.627,2.796c0.159,0.066,0.106,0.246,0.094,0.332
									c-0.012,0.086-1.38,2.164-4.705,2.766c-3.325,0.598-5.759-2.098-5.759-2.098l-5.79-5.634l6.488,0.9L63.419,24.381z"></path>
									<path fillRule="evenodd" clipRule="evenodd" fill="#5ABD88" d="M51.221,9.932c6.738,0,12.2,5.462,12.2,12.201l0.001,1.866
									c-2.703-1.072-7.16-1.772-12.201-1.772s-9.498,0.7-12.201,1.772v-1.866C39.021,15.394,44.483,9.932,51.221,9.932z"></path>
									<path fillRule="evenodd" clipRule="evenodd" fill="#192866" d="M60.089,23.044V22.47c0-6.094-3.009-11.184-7.021-12.399
