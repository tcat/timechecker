...
class Sidebar extends React.Component{
	render(){
		return(
				<aside className="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
					<ul className="nav pmd-sidebar-nav">
						<li className="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
								<div className="media-left">
									<img src="themes/images/user-icon.png" alt="New User"/>
								</div>
								<div className="media-body media-middle">Propeller Admin</div>
								<div className="media-right media-middle"><i className="dic-more-vert dic"></i></div>
							</a>
						...
						<li>
							<a className="pmd-ripple-effect" href="index.html">
								...
								<svg version="1.1" x="0px" y="0px" width="19.83px" height="18px" viewBox="287.725 407.535 19.83 18" enableBackground="new 287.725 407.535 19.83 18">
									<g>
						...
						<li className="dropdown pmd-dropdown">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
								<i className="media-left media-middle">
								<svg version="1.1" x="0px" y="0px" width="18px" height="18.001px" viewBox="0 0 18 18.001" enableBackground="new 0 0 18 18.001">
								...
								<span className="media-body">UI Elements</span>
								<div className="media-right media-bottom">
									<i className="dic-more-vert dic"></i>
								</div>
							</a>
							<ul className="dropdown-menu">
						...
						<li className="dropdown pmd-dropdown">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
								<i className="material-icons media-left pmd-sm">swap_calls</i>
								<span className="media-body">Third Party Elements</span>
						...
						<li className="dropdown pmd-dropdown">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
								<i className="media-left media-middle">
								<svg version="1.1" x="0px" y="0px" width="14.187px" height="18px" viewBox="0 0 14.187 18" enableBackground="new 0 0 14.187 18">
								...
								<span className="media-body">Form</span>
								<div className="media-right media-bottom">
									<i className="dic-more-vert dic"></i>
								</div>
							</a>
						...
						<li className="dropdown pmd-dropdown">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
								<i className="media-left media-middle">
								<svg version="1.1" x="0px" y="0px" width="18px" height="12.706px" viewBox="0 0 18 12.706" enableBackground="new 0 0 18 12.706">
									...
									h-3.176V4.235h3.176V7.412L16.942,7.412z"></path>
								</svg>
								</i>
								<span className="media-body">Table</span>
								<div className="media-right media-bottom">
									<i className="dic-more-vert dic"></i>
								</div>
							</a>
						...
						<li className="dropdown pmd-dropdown">
							<a aria-expanded="false" data-toggle="dropdown" className="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
								<i className="media-left media-middle">
								<svg x="0px" y="0px" width="18px" height="18px" viewBox="288.64 337.535 18 18" enableBackground="new 288.64 337.535 18 18">
									...
									<text transform="matrix(1 0 0 1 -0.0154 1202.2578)" fontFamily="'HelveticaNeue-Bold'" fontSize="186.0251">Created by Richard Wearn</text>
									<text transform="matrix(1 0 0 1 -0.0154 1388.2891)" fontFamily="'HelveticaNeue-Bold'" fontSize="186.0251">from the Noun Project</text>
								</svg></i>
								<span className="media-body">Pages</span>
								<div className="media-right media-bottom"><i className="dic-more-vert dic"></i></div>
							</a>
							<ul className="dropdown-menu">
						...
						<li>
							<a className="pmd-ripple-effect" href="login.html">
								<i className="media-left media-middle">
									<svg version="1.1" id="Layer_1" x="0px" y="0px" width="18px" height="18px" viewBox="288.64 337.535 18 18" enableBackground="new 288.64 337.535 18 18">
						...
						<li>
							<a className="pmd-ripple-effect" href="inbox.html">
								<i className="media-left media-middle">
									<svg version="1.1" x="0px" y="0px" width="18px" height="12.479px" viewBox="288.64 363.118 18 12.479" enableBackground="new 288.64 363.118 18 12.479">
										<g transform="translate(641.29613,1096.2351)">
											...
											c-2.304,2.303-4.192,4.188-4.198,4.188S-345.551-726.626-347.854-728.929z"></path>
										</g>
									</svg>
								</i>
						...
						<li>
							<a className="pmd-ripple-effect" href="notifications.html">
								<i className="media-left media-middle">
									<svg version="1.1" id="Layer_1" x="0px" y="0px" width="15.3px" height="18px" viewBox="289.99 337.535 15.3 18" enableBackground="new 289.99 337.535 15.3 18">
										<g>
											<g>
												...
												c-2.61,0.629-4.5,2.88-4.5,5.67v4.95l-1.8,1.8v0.9h15.3v-0.9L303.49,350.135z"></path>
											</g>
										</g>
									</svg>
								</i>
								<span className="media-body">Notifications</span>
							</a>
						</li>
					</ul>
				</aside>
